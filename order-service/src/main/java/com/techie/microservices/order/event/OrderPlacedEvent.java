...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public boolean equals(Object o) {
    ...
    if (!this.orderNumber.toString().contentEquals(other.orderNumber)) {
      return false;
    }
    if (!this.email.toString().contentEquals(other.email)) {
      return false;
    }
    if (!this.firstName.toString().contentEquals(other.firstName)) {
      return false;
    }
    if (!this.lastName.toString().contentEquals(other.lastName)) {
      return false;
    }
    return true;
  }
