...
public record IncidentAnalysis(
    ...
    public IncidentAnalysis {
        ...
        probableRootCause = normalize(probableRootCause, "Insufficient evidence to determine a root cause.", 4000);
        ...
        confidence = Double.isFinite(confidence) ? Math.clamp(confidence, 0.0, 1.0) : 0.0;
